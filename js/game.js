var game = {
  ...
  setHandlers: function() {
    ...
    $(window).on('beforeunload', function() {
      ...
      $('#tweet iframe').remove();
      var html = '<a href="https://twitter.com/share" class="twitter-share-button"{count} data-url="https://flexbox-froggy.vercel.app/" data-via="radhesh1">Tweet</a> ' +
                 '<a href="https://twitter.com/radhesh1" class="twitter-follow-button" data-show-count="false">Follow @radhesh1</a>';
      $('#tweet').html(html);
